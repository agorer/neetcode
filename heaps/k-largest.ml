...
let () =
  let _ = k_add 1 3 k_heap in
  let _ = k_add 2 3 k_heap in
  let _ = k_add 3 3 k_heap in
  let _ = k_add 3 3 k_heap in
  let _ = k_add 3 3 k_heap in
  let _ = k_add 5 3 k_heap in
  let _ = k_add 6 3 k_heap in
  let _ = k_add 7 3 k_heap in
  let _ = k_add 8 3 k_heap in
  pp k_heap
